...
The data in the fixed.acidity variable is normaly distributed with following 
statistics.
...
The data in the volatile.acidity variable is normaly distributed with following
statistics.
...
The data in the citric.acid variable is normaly distributed with following 
statistics.
```{r, echo = FALSE}
...
is a huge diffrent can be observable. This is probably due to outliers. In the 
...
After removing the outliers, folowing is rhe summary for residual.sugar 
variable. Th eremoval of outliers give much better visualization for the data 
distribution. 
...
The data in the chlorides variable is normaly distributed with following 
statistics. The extream valuss of chlorides are difficult to detrmine without
further information.
...
The data in the free.sulfur.dioxide variable is normaly distributed with 
...
In free.sulfur.dioxide also there are some potential outliers whem compare 
maximum value with the third quartile. Therefore, the extream values should be 
removed.
...
```
After removing extream values of free.sulfur.dioxide, following summary 
...
```
The data in the total.sulfur.dioxide variable is normaly distributed with 
following statistics.
...
The data in the density variable is normaly distributed with following 
statistics.
...
outliers from the dataset to clean the dataset. Following plot wes generated 
...
After removing extream values of density varible, following summary 
statistics can be observable.
...
The data in the pH variable is normaly distributed with following statistics.
...
The data in the sulphates variable is normaly distributed with following statistics.
```{r, echo = FALSE}
...
The data in the citric.acid variable is somewhat normaly distributed with 
following statistics.
...
The data in the quality variable is normaly distributed with following 
statistics.
...
In this section, each of those high to moderate relationships were investigated 
