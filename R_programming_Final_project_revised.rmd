...
create_histogram = function(variabl, binwidth = 0.25) {
                    return( ggplot(aes_string(x = variabl), data = win_data) + 
...
create_histogram('fixed.acidity')

```
            
```{r, echo = FALSE}
## Call function to create a histogram
create_histogram("volatile.acidity", 0.05)

```

```{r, echo = FALSE}
## Call function to create a histogram
create_histogram("citric.acid", 0.05)

```

```{r, echo = FALSE}
## Call function to create a histogram
create_histogram("residual.sugar", 1)

```

```{r, echo = FALSE}
## Call function to create a histogram
create_histogram("chlorides", 0.007)

```

```{r, echo = FALSE}
## Call function to create a histogram
create_histogram("free.sulfur.dioxide", 6)

```

```{r, echo = FALSE}
## Call function to create a histogram
create_histogram("total.sulfur.dioxide", 8)
...
```{r, echo = FALSE}
## Call function to create a histogram
create_histogram("pH", 0.05)

```

```{r, echo = FALSE}
## Call function to create a histogram
create_histogram("sulphates", 0.02)

```

```{r, echo = FALSE}
## Call function to create a histogram
create_histogram("alcohol", 0.25)

```

```{r, echo = FALSE}
## Call function to create a histogram
create_histogram("quality", 1)
